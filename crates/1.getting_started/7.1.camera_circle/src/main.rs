...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let our_shader = Shader::new("7.1.camera.vs".to_string(), "7.1.camera.fs".to_string());
        ...
        // -----------------------------------------------------------------------------------------------------------
        let projection = glm::perspective(45.0f32.to_radians(), (SCR_WIDTH as f32) / (SCR_HEIGHT as f32), 0.1, 100.0);
        ...
        while !window.should_close() {
            ...
            view = glm::look_at_rh(&glm::vec3(cam_x, 0.0, cam_z), &glm::vec3(0.0, 0.0, 0.0), &glm::vec3(0.0, 1.0, 0.0));
