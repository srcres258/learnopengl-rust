...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let shader = Shader::new("1.advanced_lighting.vs".to_string(), "1.advanced_lighting.fs".to_string());
        ...
        // lighting info
        // -------------
        let light_pos = glm::vec3(0.0, 0.0, 0.0);
...
fn process_input(window: &mut Window) {
    ...
    unsafe {
        if window.get_key(Key::B) == Action::Press && !BLINN_KEY_PRESSED {
            BLINN = !BLINN;
