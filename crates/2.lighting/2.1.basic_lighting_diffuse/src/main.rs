...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let lighting_shader = Shader::new("2.1.basic_lighting.vs".to_string(), "2.1.basic_lighting.fs".to_string());
        let lighting_cube_shader = Shader::new("2.1.light_cube.vs".to_string(), "2.1.light_cube.fs".to_string());
