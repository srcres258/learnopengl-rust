...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let lighting_shader = Shader::new("4.4.lighting_maps.vs".to_string(), "4.4.lighting_maps.fs".to_string());
        let lighting_cube_shader = Shader::new("4.4.light_cube.vs".to_string(), "4.4.light_cube.fs".to_string());
        ...
        let emission_map = load_texture(filesystem::get_path("resources/textures/matrix.jpg".to_string()));
        ...
        lighting_shader.set_int("material.emission".to_string(), 2);
