...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let lighting_shader = Shader::new("5.4.light_casters.vs".to_string(), "5.4.light_casters.fs".to_string());
        let _lighting_cube_shader = Shader::new("5.4.light_cube.vs".to_string(), "5.4.light_cube.fs".to_string());
