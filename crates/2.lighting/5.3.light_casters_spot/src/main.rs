...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let lighting_shader = Shader::new("5.3.light_casters.vs".to_string(), "5.3.light_casters.fs".to_string());
        let _lighting_cube_shader = Shader::new("5.3.light_cube.vs".to_string(), "5.3.light_cube.fs".to_string());
        ...
        while !window.should_close() {
            ...
            lighting_shader.use_shader();
            lighting_shader.set_vec3("light.position".to_string(), &CAMERA.lock().unwrap().position());
            lighting_shader.set_vec3("light.direction".to_string(), &CAMERA.lock().unwrap().front());
            lighting_shader.set_float("light.cutOff".to_string(), 12.5f32.to_radians().cos());
            ...
            lighting_shader.set_vec3("light.diffuse".to_string(), &(glm::vec3(0.8, 0.8, 0.8)));
