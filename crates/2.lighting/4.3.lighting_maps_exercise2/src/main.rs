...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let lighting_shader = Shader::new("4.2.lighting_maps.vs".to_string(), "4.2.lighting_maps.fs".to_string());
        let lighting_cube_shader = Shader::new("4.2.light_cube.vs".to_string(), "4.2.light_cube.fs".to_string());
