...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let lighting_shader = Shader::new("3.1.materials.vs".to_string(), "3.1.materials.fs".to_string());
        let lighting_cube_shader = Shader::new("3.1.light_cube.vs".to_string(), "3.1.light_cube.fs".to_string());
        ...
        while !window.should_close() {
            ...
            // material properties
            lighting_shader.set_vec3_coords("material.ambient".to_string(), 1.0, 0.5, 0.31);
            lighting_shader.set_vec3_coords("material.diffuse".to_string(), 1.0, 0.5, 0.31);
            lighting_shader.set_vec3_coords("material.specular".to_string(), 0.5, 0.5, 0.5); // specular lighting doesn't have full effect on this object's material
