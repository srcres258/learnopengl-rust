...
fn main() {
    ...
    unsafe {
        ...
        // ------------------------------------
        let lighting_shader = Shader::new("1.colors.vs".to_string(), "1.colors.fs".to_string());
        let lighting_cube_shader = Shader::new("1.light_cube.vs".to_string(), "1.light_cube.fs".to_string());
