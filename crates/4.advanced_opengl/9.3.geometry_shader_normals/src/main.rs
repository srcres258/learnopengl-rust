...
fn main() {
    ...
    unsafe {
        ...
        // -------------------------
        let shader = Shader::new("9.3.default.vs".to_string(), "9.3.default.fs".to_string(), None);
        let normal_shader = Shader::new("9.3.normal_visualization.vs".to_string(), "9.3.normal_visualization.fs".to_string(), Some("9.3.normal_visualization.gs".to_string()));
        ...
        while !window.should_close() {
            ...
            normal_shader.set_mat4("projection".to_string(), &projection);
            normal_shader.set_mat4("view".to_string(), &view);
            normal_shader.set_mat4("model".to_string(), &model);
